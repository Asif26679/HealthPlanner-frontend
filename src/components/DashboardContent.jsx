      ...
      >
        <div className="overflow-y-auto mt-20 md:mt-0">
          ...
          <div className="px-6">
            ...
            <div className={`transition-all duration-300 overflow-hidden ${dietSectionOpen ? "max-h-[1000px]" : "max-h-0"}`}>
          ...
          <div className="px-6 mt-6 border-t border-gray-700 pt-4">
            ...
            <div className={`transition-all duration-300 overflow-hidden ${userSectionOpen ? "max-h-[500px]" : "max-h-0"}`}>
